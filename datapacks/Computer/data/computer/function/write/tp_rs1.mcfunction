...
scoreboard players operation input_0 scoretp_z = rs1_12 Computer
scoreboard players operation input_1 scoretp_z = rs1_13 Computer
scoreboard players operation input_2 scoretp_z = rs1_14 Computer
scoreboard players operation input_3 scoretp_z = rs1_15 Computer
scoreboard players operation input_4 scoretp_z = rs1_16 Computer
scoreboard players operation input_5 scoretp_z = rs1_17 Computer
scoreboard players operation input_6 scoretp_z = rs1_18 Computer
scoreboard players operation input_7 scoretp_z = rs1_19 Computer
scoreboard players operation input_8 scoretp_z = rs1_20 Computer
scoreboard players operation input_9 scoretp_z = rs1_21 Computer
...
scoreboard players operation input_0 scoretp_y = rs1_24 Computer
scoreboard players operation input_1 scoretp_y = rs1_25 Computer
scoreboard players operation input_2 scoretp_y = rs1_26 Computer
scoreboard players operation input_3 scoretp_y = rs1_27 Computer
scoreboard players operation input_4 scoretp_y = rs1_28 Computer
scoreboard players operation input_5 scoretp_y = rs1_29 Computer
scoreboard players operation input_6 scoretp_y = rs1_30 Computer
scoreboard players operation input_7 scoretp_y = rs1_31 Computer
