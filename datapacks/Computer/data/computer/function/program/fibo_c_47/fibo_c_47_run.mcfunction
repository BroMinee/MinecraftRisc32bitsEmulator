# load
function computer:program/fibo_c_47/fibo_c_47_load
# run
execute as @e[tag=pc, limit=1] run function computer:program/fibo_c_47/fibo_c_47_run_until_end
# end
...
function computer:debug/register/pre_debug_rd_x10
