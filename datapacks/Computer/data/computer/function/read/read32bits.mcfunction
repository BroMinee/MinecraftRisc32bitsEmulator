...
execute at @s positioned ~2 ~ ~ run function computer:read/read8bits
scoreboard players operation read_16 Computer = read_0 read8
scoreboard players operation read_17 Computer = read_1 read8
scoreboard players operation read_18 Computer = read_2 read8
scoreboard players operation read_19 Computer = read_3 read8
scoreboard players operation read_20 Computer = read_4 read8
scoreboard players operation read_21 Computer = read_5 read8
scoreboard players operation read_22 Computer = read_6 read8
scoreboard players operation read_23 Computer = read_7 read8


execute at @s positioned ~3 ~ ~ run function computer:read/read8bits
scoreboard players operation read_24 Computer = read_0 read8
scoreboard players operation read_25 Computer = read_1 read8
scoreboard players operation read_26 Computer = read_2 read8
scoreboard players operation read_27 Computer = read_3 read8
scoreboard players operation read_28 Computer = read_4 read8
scoreboard players operation read_29 Computer = read_5 read8
scoreboard players operation read_30 Computer = read_6 read8
scoreboard players operation read_31 Computer = read_7 read8
