tellraw @a[tag=DEBUG] [{"text":""},{"text":""},{"text":"[DEBUG] - ","bold":true,"color":"blue"},{"text":"Running lh","color":"gold"}]
# tellraw @a[tag=ERROR] [{"text":""},{"text":""},{"text":"Error: Not Yet Implemented lh","bold":true,"color":"red"}]
...
scoreboard players operation rd_17 Computer = rd_15 Computer
scoreboard players operation rd_18 Computer = rd_15 Computer
scoreboard players operation rd_19 Computer = rd_15 Computer
scoreboard players operation rd_20 Computer = rd_15 Computer
scoreboard players operation rd_21 Computer = rd_15 Computer
scoreboard players operation rd_22 Computer = rd_15 Computer
scoreboard players operation rd_23 Computer = rd_15 Computer
scoreboard players operation rd_24 Computer = rd_15 Computer
scoreboard players operation rd_25 Computer = rd_15 Computer
scoreboard players operation rd_26 Computer = rd_15 Computer
scoreboard players operation rd_27 Computer = rd_15 Computer
scoreboard players operation rd_28 Computer = rd_15 Computer
scoreboard players operation rd_29 Computer = rd_15 Computer
scoreboard players operation rd_30 Computer = rd_15 Computer
scoreboard players operation rd_31 Computer = rd_15 Computer
