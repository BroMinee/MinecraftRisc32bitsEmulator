...
execute if score pc_0 Computer matches 1 run scoreboard players set error stats 1 
...
execute if score pc_1 Computer matches 1 run scoreboard players set error stats 1 
...
execute if score pc_31 Computer matches 1 run tellraw @a[tag=WARNING] [{"text":""},{"text":""},{"text":"[WARNING] - ","bold":true,"color":"dark_purple"},{"text":"[TP PC]: pc_31 will by ignored","bold":true,"color":"light_purple"}]
...
scoreboard players operation input_0 scoretp_z = pc_10 Computer
scoreboard players operation input_1 scoretp_z = pc_11 Computer
scoreboard players operation input_2 scoretp_z = pc_12 Computer
scoreboard players operation input_3 scoretp_z = pc_13 Computer
scoreboard players operation input_4 scoretp_z = pc_14 Computer
scoreboard players operation input_5 scoretp_z = pc_15 Computer
scoreboard players operation input_6 scoretp_z = pc_16 Computer
scoreboard players operation input_7 scoretp_z = pc_17 Computer
scoreboard players operation input_8 scoretp_z = pc_18 Computer
scoreboard players operation input_9 scoretp_z = pc_19 Computer
...
scoreboard players operation input_0 scoretp_y = pc_20 Computer
scoreboard players operation input_1 scoretp_y = pc_21 Computer
scoreboard players operation input_2 scoretp_y = pc_22 Computer
scoreboard players operation input_3 scoretp_y = pc_23 Computer
scoreboard players operation input_4 scoretp_y = pc_24 Computer
scoreboard players operation input_5 scoretp_y = pc_25 Computer
scoreboard players operation input_6 scoretp_y = pc_26 Computer
scoreboard players operation input_7 scoretp_y = pc_27 Computer
